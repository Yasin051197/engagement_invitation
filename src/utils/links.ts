...
/** Pre-filled WhatsApp chat to the RSVP contact: wa.me/{phone}?text={msg} */
export function buildWhatsAppRsvpLink(data: InvitationData): string {
  const phone = sanitizePhone(data.rsvpPhone)
